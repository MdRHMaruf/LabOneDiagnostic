...
public class AdvancedSearch extends JDialog{
	...
	protected void idSelectionEvent(Object valueAt) {
		...
		if(!checkAllMonth.isSelected()) labBilling.cmbBillMonth.setSelectedIndex(cmbMonth.getSelectedIndex());
		if(!checkAllYear.isSelected()) labBilling.cmbFiscalYear.setSelectedIndex(cmbYear.getSelectedIndex());
		labBilling.cmbFindLabBill.txtMrNo.setText(valueAt.toString());
		this.setVisible(false);
		labBilling.btnClearEvent();
		labBilling.btnFindEvent(valueAt.toString(), cmbYear.getSelectedItem().toString(), cmbMonth.getSelectedItem().toString());
