...
public class top extends JPanel{
	...
	JTextField txtGroupName=new JTextField(60);
...
/*	    @Override
	...
	public void btnPrintEvent(String BillId,String Cabin,String Reg,String Name,String Age,String Month,String Day,String Sex,String Consultant,Date OrDate,String TestGroup,String FiscalYear,String BillMonth){
		try {
			
			String ConsultantName="",Degree="";
			ResultSet rs=db.sta.executeQuery("select (select Name from tbdoctorinfo where DoctorCode=TbLabPatient.RefferBy) as DcName,(select Degree from tbdoctorinfo where DoctorCode=TbLabPatient.RefferBy) as DegreeName from TbLabPatient where labId='"+BillId+"' and FiscalYear = '"+FiscalYear+"' and CMonth='"+BillMonth+"'");
			while(rs.next()){
				ConsultantName=rs.getString("DcName");
				//Degree = rs.getString("DegreeName");
				Degree=rs.getString("DegreeName")!=null?rs.getString("DegreeName"):"";
			}
				...
				map.put("GroupName",txtGroupName.getText().trim().toString());
	...
	public void setExamName(String ExamName,String GropName){
		txtGroupName.setText(GropName);
	...
	public void inits(){
		...
		mainPanel.add(lblGroupName);
		lblGroupName.setPreferredSize(new Dimension(100, 32));
