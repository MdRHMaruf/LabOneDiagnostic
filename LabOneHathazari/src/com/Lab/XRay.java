...
public class XRay extends JPanel{
	...
	JTextField txtComment=new JTextField(85);
	...
	public XRay(SessionBeam sessionBeam){
			...
			if(confrim==JOptionPane.YES_OPTION){
				for(int a=0;a<table.getRowCount();a++){
					...
					if(table.getValueAt(a, 2).toString()!=""){
						if(!checkLabReport(Integer.parseInt(table.getValueAt(a, 0).toString()),labId,7)){
	...
	private void CenterPanel() {
		...
		Scroll.setPreferredSize(new Dimension(1080, 370));
