...
public class DoctorComissionSet extends JPanel{
	...
	JLabel lblDoctorName=new JLabel("Reffer Persion Name");
...
/*		eastPanel.add(eastSouthPanel, BorderLayout.SOUTH);
	...
	private void eastNorthPanel_work() {
		...
		cmbTestGroup.combo.setPreferredSize(new Dimension(160, 30));
		...
		cmbDoctorName.combo.setPreferredSize(new Dimension(260, 30));
	...
	private void eastCenterPanel_work() {
		...
		TestScroll.setPreferredSize(new Dimension(980, 470));
		...
		Testtable.getColumnModel().getColumn(2).setPreferredWidth(420);
