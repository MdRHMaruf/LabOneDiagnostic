...
public class LabRptHome extends JPanel{
	...
	JLabel lblBedcabin=new JLabel("B/C");
	...
	JComboBox cmbBillMonth=new JComboBox(BillMonth);

	JTextField txtBedCabin=new JTextField(7);
	JTextField txtRegNo=new JTextField(9);
	...
	static JComboBox<String> cmbDoctorName =new JComboBox<>();

	JLabel lblDate=new JLabel("Date");

	String Col[]={"T.ID","Test Name","Group Name","View","Result Status"};
	Object Row[][]={};
	...
	public LabRptHome(SessionBeam sessionBeam){
		...
		cmbBillMonth.setSelectedItem(getCurrentMonth());
	}
				...
				if(!txtPatientName.getText().trim().toString().isEmpty()){
					if(!txtAge.getText().trim().toString().isEmpty() || !txtMonth.getText().trim().toString().isEmpty() || !txtDay.getText().trim().toString().isEmpty()){
						if(!cmbSex.getSelectedItem().toString().isEmpty()){
							int a=tab.getSelectedIndex();
							if(a==0){
								if(checkLabReport("1",txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
									haematoloty.setData("1",txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
									haematoloty.btnPrintEvent(table.getValueAt(table.getSelectedRow(), 0).toString(),table.getValueAt(table.getSelectedRow(), 1).toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),txtBedCabin.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"1",txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
								}
								else{
							...
							if(a==1){
								...
								for(int b=0;b<table.getRowCount();b++){
									...
									if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Bio-Chemistry")){
										if(checkLabReport("2",txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
											MainTestList=MainTestList+table.getValueAt(b, 1).toString()+", ";
											bioChemestry.setPrintData("2",table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
											flag++;
										}
										else{
								...
								if(flag!=0){
									bioChemestry.btnPrintEvent(txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtBedCabin.getText().trim().toString(),txtConsultantName.getText().trim(),txtDate.getDate(),MainTestList,cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
								}
								else{
									JOptionPane.showMessageDialog(null, "Result is Not ready Yet!!");
								}
							...
							if(a==2){
								...
								for(int b=0;b<table.getRowCount();b++){
									...
									if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Serology")){
										if(checkLabReport("3",txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
											MainTestList=MainTestList+table.getValueAt(b, 1).toString()+", ";
											serology.setPrintData("3",table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
											flag++;
										}
										else{
								...
								if(flag!=0){
									serology.btnPrintEvent(txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtBedCabin.getText().trim().toString(),txtConsultantName.getText().trim(),txtDate.getDate(),MainTestList,cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
								}
								else{
									JOptionPane.showMessageDialog(null, "Result is Not ready Yet!!");
								}
							...
							if(a==3){
								...
								for(int b=0;b<table.getRowCount();b++){
									...
									if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Hormone")){
										if(checkLabReport("4",txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
											MainTestList=MainTestList+table.getValueAt(b, 1).toString()+", ";
											hormon.testList= table.getValueAt(table.getSelectedRow(), 1).toString();
											hormon.setPrintData("4",table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
											flag++;
										}
										else{
								...
								if(flag!=0){
									...
									hormon.btnPrintEvent(txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtBedCabin.getText().trim().toString(),txtConsultantName.getText().trim(),txtDate.getDate(),MainTestList,cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
								}
								else{
									JOptionPane.showMessageDialog(null, "Result is Not ready Yet!!");
								}
							...
							if(a==4){
								urine.btnPrintEvent(table.getValueAt(table.getSelectedRow(), 0).toString(),txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),txtBedCabin.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"5",txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 1).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());	
							}
							if(a==5){
								stoolEx.btnPrintEvent(table.getValueAt(table.getSelectedRow(), 0).toString(),txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),txtBedCabin.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"8",txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 1).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());	
							}
							/*				if(a==5){
								stoolEx.btnPrintEvent(txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"6");	
							}*/
							/*				if(a==6){
								Top.btnPrintEvent(txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"7");	
							}*/
							if(a==6){
								ultrasongraphy.rowAdd();
								ultrasongraphy.setFinalData("7", txtFindLabBill.getValue().toString(), txtDate.getDate());
								ultrasongraphy.btnPrintEvent(txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"7",table.getValueAt(table.getSelectedRow(), 1).toString());	
							}
							/*				if(a==8){
								cytology.btnPrintEvent(txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"9");	
							}*/
							if(a==8){
								int flag=0;
								...
								for(int b=0;b<table.getRowCount();b++){
									...
									if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Immunology")){
										if(checkLabReport("9",txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
											MainTestList=MainTestList+table.getValueAt(b, 1).toString()+", ";
											immunology.setPrintData("9",table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
											flag++;
										}
										else{
								...
								if(flag!=0){
									//System.out.println("Hey");
									immunology.btnPrintEvent(txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtBedCabin.getText().trim().toString(),txtConsultantName.getText().trim(),txtDate.getDate(),MainTestList,cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
								}
								else{
									JOptionPane.showMessageDialog(null, "Result is Not ready Yet!!");
								}
							...
							if(a==9){
								//Top.setExamName(table.getValueAt(table.getSelectedRow(), 1).toString(),table.getValueAt(table.getSelectedRow(), 2).toString());
								Top.btnPrintEvent(txtFindLabBill.getValue().toString(),txtBedCabin.getText().trim().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 2).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());	
							}
							if(a==10){
								microbio.btnPrintEvent(table.getValueAt(table.getSelectedRow(), 0).toString(),txtFindLabBill.getValue().toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),txtBedCabin.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"6",txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 1).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							if(a==11){
								if(checkLabReport("10",txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
									pathology.setData("10",txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
									pathology.btnPrintEvent(table.getValueAt(table.getSelectedRow(), 0).toString(),table.getValueAt(table.getSelectedRow(), 1).toString(),txtRegNo.getText().trim().toString(),txtPatientName.getText().trim().toString(),txtAge.getText().trim().toString(),txtMonth.getText().trim().toString(),txtDay.getText().trim().toString(),txtBedCabin.getText().trim().toString(),cmbSex.getSelectedItem().toString(),txtConsultantName.getText().trim(),txtFindLabBill.getValue().toString(),"10",txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
								}
								else{
									JOptionPane.showMessageDialog(null, "Result is Not ready Yet!!");
								}
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if(table.getSelectedColumn()==3){
					try {
						...
						String SN="";
						ResultSet rs=db.sta.executeQuery("select SN,tblabtestgroup.GroupName from tblabtestgroup where SN=(SELECT tbtestname.TestHeadId FROM tbtestname WHERE tbtestname.TestCode='"+table.getValueAt(table.getSelectedRow(), 0)+"') ");
						while(rs.next()){
							SN=rs.getString("SN");
						}
						...
						if(SN.equals("1")){
							...
							if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
								haematoloty.setData(SN,txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(),0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							else{
							...
							for(int b=0;b<table.getRowCount();b++){
								...
								if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Bio-Chemistry")){
									if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
										...
										bioChemestry.setFinalData(SN,table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
									}
									else{
										bioChemestry.setData(table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString());
									}
							...
							for(int b=0;b<table.getRowCount();b++){
								...
								if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Serology")){
									if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
										serology.setFinalData(SN,table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
									}
									else{
										serology.setData(table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString());
									}
							...
							for(int b=0;b<table.getRowCount();b++){
								...
								if(rescheck.booleanValue() && table.getValueAt(b, 2).toString().equals("Hormone")){
									if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
										System.out.println("Row "+b);
										hormon.testList= table.getValueAt(table.getSelectedRow(), 1).toString();
										hormon.setFinalData(SN,table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
									}
									else{
										hormon.setData(table.getValueAt(b, 0).toString(),table.getValueAt(b, 1).toString());
									}
							...
							if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
								urine.setData(SN,txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							search=5;
						}
						else if(SN.equals("6")){
							...
							if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
								microbio.setData(SN,txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							search=10;
						}
						else if(SN.equals("8")){
							...
							if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
								stoolEx.setData(SN,txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(), 0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							search=6;
						}
						else if(SN.equals("7")){
							...
							if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
								immunology.setFinalData(SN,table.getValueAt(table.getSelectedRow(), 0).toString(),table.getValueAt(table.getSelectedRow(), 1).toString(),txtFindLabBill.getValue().toString(),txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							else{
							...
							if(checkLabReport(SN,txtFindLabBill.getValue().toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString())){
								pathology.setData(SN,txtFindLabBill.getValue().toString(),txtDate.getDate(),table.getValueAt(table.getSelectedRow(),0).toString(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
							}
							else{
	...
	public void btnSaveEvent() {
		if(search==0){
			...
			haematoloty.savebtnActionEvent(s,labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==2){
			String labId=txtFindLabBill.getValue().toString();
			bioChemestry.savebtnActionEvent(labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==3){
			String labId=txtFindLabBill.getValue().toString();
			serology.savebtnActionEvent(labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==4){
			String labId=txtFindLabBill.getValue().toString();
			hormon.savebtnActionEvent(labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==5){
			String s=table.getValueAt(table.getSelectedRow(), 0).toString();
			String labId=txtFindLabBill.getValue().toString();
			urine.savebtnActionEvent(s,labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==6){
			String s=table.getValueAt(table.getSelectedRow(), 0).toString();
			String labId=txtFindLabBill.getValue().toString();
			stoolEx.savebtnActionEvent(s,labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==7){
			String s=table.getValueAt(table.getSelectedRow(), 0).toString();
			String labId=txtFindLabBill.getValue().toString();
			...
			String labId=txtFindLabBill.getValue().toString();
			immunology.savebtnActionEvent(labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==10){
			String s=table.getValueAt(table.getSelectedRow(), 0).toString();
			String labId=txtFindLabBill.getValue().toString();
			microbio.savebtnActionEvent(s,labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
		else if(search==11){
			String s=table.getValueAt(table.getSelectedRow(), 0).toString();
			String labId=txtFindLabBill.getValue().toString();
			pathology.savebtnActionEvent(s,labId,txtDate.getDate(),cmbFiscalYear.getSelectedItem().toString().toString(),cmbBillMonth.getSelectedItem().toString());
		}
	...
	private void btnFindEvent(String LabBillNo) {
		...
		if(checkLabBill(LabBillNo)){
			try {
				ResultSet rs=db.sta.executeQuery("select *,(select name from tbdoctorinfo where DoctorCode =tblabpatient.RefferBy)as RefferName,(select degree from tbdoctorinfo where DoctorCode =tblabpatient.RefferBy) as DegreeName from tblabpatient where labId='"+LabBillNo+"' and FiscalYear='"+cmbFiscalYear.getSelectedItem()+"' and CMonth='"+cmbBillMonth.getSelectedItem().toString()+"'");
				while(rs.next()){
					txtFindLabBill.setValue(Integer.parseInt(rs.getString("MrNo")));
					txtRegNo.setText(rs.getString("RegNo").startsWith("RN")?rs.getString("RegNo"):"");
				...
				String query="select tblabtesthistory.testCode,tblabtesthistory.testName,tblabtesthistory.ResultStatus,(select (select tblabtestgroup.GroupName from tblabtestgroup where SN=tbtestname.TestHeadId)  from tbtestname where testCode=tblabtesthistory.testCode)as GroupName from tblabtesthistory where labId='"+LabBillNo+"' and FiscalYear='"+cmbFiscalYear.getSelectedItem()+"' and CMonth='"+cmbBillMonth.getSelectedItem().toString()+"' and type=1";
				System.out.println(query);
				ResultSet rs1=db.sta.executeQuery(query);
				while(rs1.next()){
					model.addRow(new Object[]{rs1.getString("TestCode"),rs1.getString("testName"),rs1.getString("GroupName"),new Boolean(false),rs1.getString("ResultStatus")});
				}
	...
	public void setLastBill(){
		try {
			//db.conect();
			ResultSet rs=db.sta.executeQuery("select TOP 1 labId from TbLabPatient where FiscalYear='"+cmbFiscalYear.getSelectedItem()+"' and CMonth='"+cmbBillMonth.getSelectedItem().toString()+"' order by labId desc ");
			String LabBill="";
			while(rs.next()){
	...
	private boolean checkLabBill(String LabBill){
		try {
			ResultSet rs=db.sta.executeQuery("select labId from tblabpatient where tblabpatient.labId='"+LabBill+"' and FiscalYear='"+cmbFiscalYear.getSelectedItem()+"' and CMonth='"+cmbBillMonth.getSelectedItem().toString()+"'");
			while(rs.next()){
				return true;
			}
		} catch (Exception e) {
	...
	private void loadDoctorName(){
		try {
			...
			cmbDoctorName.addItem("");
			String sql  = "select name from tbLabInchargeConsultantDegree where designation = 'Consultant'";
			ResultSet rs = db.sta.executeQuery(sql);
			while(rs.next()) {
				cmbDoctorName.addItem(rs.getString("name"));
			}
		}catch(Exception e) {
			e.printStackTrace();
	...
	private void NorthWestPanel_work() {
		...
		NorthWestPanel.add(lblBillMonth);
		NorthWestPanel.add(cmbBillMonth);
		...
		btnFind.setPreferredSize(new Dimension(80, 36));
		btnFind.setMnemonic(KeyEvent.VK_F);



		NorthWestPanel.add(lblRegNo);
		NorthWestPanel.add(txtRegNo);
	...
	public boolean checkLabReport(String labPid,String labBillId,String FiscalYear,String BillMonth){
		try {
			String sql="select labPId,labBillId,testCode from tblabreportvalue where labPId='"+labPid+"' and labBillId='"+labBillId+"' and FiscalYear='"+FiscalYear+"' and CMonth='"+BillMonth+"' ";
	...
	private void SouthPanel_work() {
		...
		lblTemp.setPreferredSize(new Dimension(400, 20));
		SouthPanel.add(lblTemp);
		...
		lblTemp2.setPreferredSize(new Dimension(30, 20));
		SouthPanel.add(lblTemp2);
		
		SouthPanel.add(lblDoctorName);
		SouthPanel.add(cmbDoctorName);
		cmbDoctorName.setPreferredSize(new Dimension(150, 30));;
	...
	public static  String getDoctorName() {
		return cmbDoctorName.getSelectedItem().toString();
	}
}
